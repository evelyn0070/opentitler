                    ...
                    q-scroll-area.full-height.pad-bottomxl
                      div(
                        ...
                        q-item.border-off(
                          ...
                          q-item-section(side, v-if="content.emoji")
            ...
            .col-12.col-md-6.offset-md-3
              q-card.bg-grey-10(flat, bordered)
                q-card-section
                  ...
                  emoji-panel(
                    v-if="newcontent.itemtype=='emoji'"
                    v-model="newcontent.emoji"
                  )
                  q-input(
                    label="Image URL",
                    type="text",
              ...
              .q-mt-md(
                ...
                q-card.bg-grey-10.full-height.relative(flat, bordered)
                  ...
                  q-card-section.col-auto(v-if="content.emoji")
                    emoji(:text="content.emoji")
                  q-separator
                ...
                q-timeline-entry(subtitle="Settings")
                  q-input(
                    ...
                    template(v-slot:append, v-if="dirty.name != display.name")
                      q-avatar
                        q-icon(name="create")
                q-timeline-entry(subtitle="Bullet Screen")
                  q-input(
                    v-model="bullet.inDuration"
                    placeholder="duration"
                    label="in seconds"
                    v-on:keyup.enter="updateBullet"
                    hint="Repeat a certain number of times within the specified time, and a barrage or rain effect will appear"
                    type="number"
                  )
                  q-input(
                    v-model="bullet.rainRepeat"
                    placeholder="rain repeat count"
                    label="rain repeat count"
                    v-on:keyup.enter="updateBullet"
                    type="number"
                  )
                  q-input(
                    v-model="bullet.repeatCount"
                  ...
                  q-input(
                    v-model="bullet.fontSize"
                    placeholder="bullet font size"
                    label="fontSize"
                    type="number"
                    v-on:keyup.enter="updateBullet"
                  )
...
export default {
  ...
  methods: {
    ...
    content_add() {
      ...
      this.newcontent = {
        itemtype: this.newcontent.itemtype || "message",
        message: "",
        image: "",
        caption: "",
      };
    ...
    updateBullet(){
      this.$firebaseRefs.display.child('bullet').set(this.bullet)
    },
    updatelive() {
      // console.log(val);
      this.$firebaseRefs.display
